...
A Pokémon Species forms the basis for at least one Pokémon. Attributes of Pokémon species are shared across all varieties of Pokémon within the species.
Endpoint: [https://pokeapi.co/api/v2/pokemon-species/](https://pokeapi.co/api/v2/pokemon-species/)
...
Endpoint: [https://pokeapi.co/api/v2/pokemon-species/1/](https://pokeapi.co/api/v2/pokemon-species/1/)
