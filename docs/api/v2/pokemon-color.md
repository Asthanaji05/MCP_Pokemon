...
Colors used for sorting Pokémon in a Pokédex. The color listed in the Pokédex is usually the color most apparent or covering each Pokémon's body.
Endpoint: [https://pokeapi.co/api/v2/pokemon-color/](https://pokeapi.co/api/v2/pokemon-color/)
...
Endpoint: [https://pokeapi.co/api/v2/pokemon-color/1/](https://pokeapi.co/api/v2/pokemon-color/1/)
