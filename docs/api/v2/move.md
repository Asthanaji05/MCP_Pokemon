...
Endpoint: [https://pokeapi.co/api/v2/move/](https://pokeapi.co/api/v2/move/)
...
Endpoint: [https://pokeapi.co/api/v2/move/1/](https://pokeapi.co/api/v2/move/1/)
...
```json
{
  ...
  "flavor_text_entries": [
    ...
    {
      "flavor_text": "The target is physically pounded with a long tail, a foreleg, or the like.",
      "language": {
        "name": "en",
        "url": "https://pokeapi.co/api/v2/language/9/"
      },
