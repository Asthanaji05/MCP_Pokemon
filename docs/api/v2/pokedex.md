...
Endpoint: [https://pokeapi.co/api/v2/pokedex/](https://pokeapi.co/api/v2/pokedex/)

```json
{
  "count": 33,
  "next": "https://pokeapi.co/api/v2/pokedex/?offset=20&limit=13",
  "previous": null,
  "results": [
    {
      "name": "national",
...
Endpoint: [https://pokeapi.co/api/v2/pokedex/1/](https://pokeapi.co/api/v2/pokedex/1/)
