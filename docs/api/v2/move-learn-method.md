...
Endpoint: [https://pokeapi.co/api/v2/move-learn-method/](https://pokeapi.co/api/v2/move-learn-method/)
...
Endpoint: [https://pokeapi.co/api/v2/move-learn-method/1/](https://pokeapi.co/api/v2/move-learn-method/1/)

```json
{
  "descriptions": [
    {
      "description": "Appris lorsqu’un Pokémon atteint un certain niveau.",
      "language": {
        "name": "fr",
