...
Endpoint: [https://pokeapi.co/api/v2/evolution-trigger/](https://pokeapi.co/api/v2/evolution-trigger/)
...
Endpoint: [https://pokeapi.co/api/v2/evolution-trigger/1/](https://pokeapi.co/api/v2/evolution-trigger/1/)
