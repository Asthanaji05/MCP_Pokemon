...
Endpoint: [https://pokeapi.co/api/v2/type/](https://pokeapi.co/api/v2/type/)
...
Endpoint: [https://pokeapi.co/api/v2/type/1/](https://pokeapi.co/api/v2/type/1/)
...
```json
{
  ...
  "moves": [
    ...
    {
      "name": "blood-moon",
      "url": "https://pokeapi.co/api/v2/move/901/"
    },
    {
      "name": "tera-starstorm",
  ...
  "sprites": {
    ...
    "generation-viii": {
      "brilliant-diamond-and-shining-pearl": {
        "name_icon": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-viii/brilliant-diamond-and-shining-pearl/1.png"
      },
      "legends-arceus": {
