...
Endpoint: [https://pokeapi.co/api/v2/pokemon-shape/](https://pokeapi.co/api/v2/pokemon-shape/)
...
Endpoint: [https://pokeapi.co/api/v2/pokemon-shape/1/](https://pokeapi.co/api/v2/pokemon-shape/1/)
