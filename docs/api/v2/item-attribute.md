...
Endpoint: [https://pokeapi.co/api/v2/item-attribute/](https://pokeapi.co/api/v2/item-attribute/)
...
Endpoint: [https://pokeapi.co/api/v2/item-attribute/1/](https://pokeapi.co/api/v2/item-attribute/1/)
...
```json
{
  ...
  "items": [
    ...
    {
      "name": "linking-cord",
      "url": "https://pokeapi.co/api/v2/item/2160/"
    }
  ],
  "name": "countable",
  "names": [
