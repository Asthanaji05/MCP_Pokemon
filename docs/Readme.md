...
This is the documentation for the PokeAPI v2.
...
> Note:
You can generate the `api/v2` files using the `generate_docs.js` script.
and update the descriptions using the `scrape_descriptions.js` script.
It is using the `descriptions.json` file to generate the docs.
---
> Citation:
